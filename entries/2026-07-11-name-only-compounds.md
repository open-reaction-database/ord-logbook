...
- **Extraction:** two `\copy` queries over `ord.compound_identifier` (~48.5M rows), one per owning
  ...
  [`name_only_compounds.tsv.gz`](../assets/2026-07-11-name-only-compounds/name_only_compounds.tsv.gz)
  and
  [`name_only_product_compounds.tsv`](../assets/2026-07-11-name-only-compounds/name_only_product_compounds.tsv)
...
- **Union + junk filter:** dedup across both files (52,651 unique names), then drop obvious
  ...
  ("EtOAc hexanes") — with
  [`filter_names.py`](../assets/2026-07-11-name-only-compounds/filter_names.py). Kept 46,831,
  skipped 5,820. Real solvents/reagents and systematic names are retained.
- **Automated resolver:** [`run_resolver.py`](../assets/2026-07-11-name-only-compounds/run_resolver.py)
  ...
  [`resolver_results.tsv.gz`](../assets/2026-07-11-name-only-compounds/resolver_results.tsv.gz)
  (`name⇥smiles⇥resolver`).
- **Manual dictionary:** [`manual_resolve.py`](../assets/2026-07-11-name-only-compounds/manual_resolve.py)
...
- **Combined:** manual ∪ OPSIN, manual taking precedence on overlap, CIR dropped:
  [`combined_resolved.tsv`](../assets/2026-07-11-name-only-compounds/combined_resolved.tsv)
  (`name⇥smiles⇥source`).
...
- Assets: [`name_only_compounds.tsv.gz`](../assets/2026-07-11-name-only-compounds/name_only_compounds.tsv.gz),
  [`name_only_product_compounds.tsv`](../assets/2026-07-11-name-only-compounds/name_only_product_compounds.tsv),
  [`filter_names.py`](../assets/2026-07-11-name-only-compounds/filter_names.py),
  [`run_resolver.py`](../assets/2026-07-11-name-only-compounds/run_resolver.py),
  [`resolver_results.tsv.gz`](../assets/2026-07-11-name-only-compounds/resolver_results.tsv.gz),
  [`manual_resolve.py`](../assets/2026-07-11-name-only-compounds/manual_resolve.py),
  [`manual_resolved.tsv`](../assets/2026-07-11-name-only-compounds/manual_resolved.tsv),
  [`combined_resolved.tsv`](../assets/2026-07-11-name-only-compounds/combined_resolved.tsv).
