...
[The projection](2026-07-31-projection-search-index.md) exists to unlock a much larger
...
[Measured earlier](2026-07-31-projection-search-index.md): `UNNEST` in a `FROM` clause
...
- [Agent access: sidecars or the ORM?](2026-07-30-agent-access-sidecars-or-orm.md)
- [Does the projection need a search index?](2026-07-31-projection-search-index.md)
- [EAV versus the projection](2026-07-31-eav-versus-projection.md)
