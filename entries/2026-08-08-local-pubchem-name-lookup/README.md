...
and CIR has been unreliable — [2026-07-11](../2026-07-11-name-only-compounds/README.md) found it
...
is reproducible at roughly 30 requests. [2026-07-11](../2026-07-11-name-only-compounds/README.md)
...
- **Ship one artifact: the slim Parquet, 806 MiB, written with 50k-row groups and a Bloom
  ...
  ([2026-07-25](../2026-07-25-derived-parquet-sidecars/README.md)) — same distribution, same
...
- **Read it with `pyarrow`, not DuckDB, from `resolvers.py`.** pyarrow is already a core
  ...
  ([2026-07-25 scripts boundary](../2026-07-25-ord-schema-scripts-boundary/README.md) is the entry
...
- Prior entries: [2026-07-11 name-only compounds](../2026-07-11-name-only-compounds/README.md) (the
  inventory, the junk filter, and the curated dictionary this builds on),
  [2026-07-25 derived parquet sidecars](../2026-07-25-derived-parquet-sidecars/README.md) (the
  HuggingFace distribution this would reuse),
  [2026-07-25 where ord-schema ends](../2026-07-25-ord-schema-scripts-boundary/README.md) (why the
