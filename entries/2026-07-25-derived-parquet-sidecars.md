...
[2026-07-25 native sharding within a dataset ID](2026-07-25-native-sharding-in-data.md),
...
(see [2026-07-02](2026-07-02-full-ord-e2e-run-classification-wall.md), where CPU
...
- Companion entry: [2026-07-25 native sharding within a dataset ID](2026-07-25-native-sharding-in-data.md)
  (shared part-directory mechanism for `data/`).
- Prior entries: [2026-07-02 full-ORD end-to-end run](2026-07-02-full-ord-e2e-run-classification-wall.md)
  (classification CPU wall), [2026-07-02 reaction classification](2026-07-02-reaction-classification.md),
  [2026-06-26 natural-language query interface](2026-06-26-natural-language-query-interface.md).
