...
Scripts behind [2026-08-08 a local PubChem name lookup](../../entries/2026-08-08-local-pubchem-name-lookup.md).
...
[2026-07-11 assets](../2026-07-11-name-only-compounds/) by relative path, so run them
from this directory.
