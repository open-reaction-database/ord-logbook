...
Scripts behind [2026-07-31 normalized EAV versus normalized projection](../../entries/2026-07-31-eav-versus-projection.md).
...
[the agent-access entry's assets](../2026-07-30-agent-access-sidecars-or-orm/); the
selection and wide-analysis timings come from the scripts in
[the search-index entry's assets](../2026-07-31-projection-search-index/).
